...
export const metadata: Metadata = {
  ...
  description: "A psicóloga Andreia Taufner, oferece terapia individualizada para adolescentes, adultos e idodos em Vila Velha/ES.",
  keywords: ["Psicoterapia", "Terapia", "Psicologia", "Andreia Taufner", "Psicóloga Clínica", "Vila Velha", "cidade Vila Velha", "ES", "Estado do Espírito Santo", "Psicóloga Clínica em Vila Velha/ES", "Terapia em Vila Velha/ES", "Psicoterapia em Vila Velha/ES", "Ansiedade", "Transtornos de ansiedade", "Psicoterapia para ansiedade", "Depressão", "Psicoterapia para depressão", "Autoconhecimento", "Psicoterapia para autoconhecimento", "Desenvolvimento pessoal", "Psicoterapia para desenvolvimento pessoal", "adolescentes", "adultos", "Psicoterapia para adolescentes", "Psicoterapia para adultos", "Problemas comportamentais", "Transtorno do Déficit de Atenção", "TDA", "Transtorno do Déficit de Atenção e Hiperatividade", "TDAH", "Psicoterapia para TDAH", "Orientação de pais e responsáveis", "Orientação profissional", "Transtorno Obsessivo Compulsivo", "TOC", "Traumas", "Transtornos relacionados a traumas", "Distúrbio do sono", "Comportamento alimentar", "Distúrbio alimentar", "Autoestima", "Autocuidado", "Relacionamentos familiares", "relacionamentos interpessoais", "online", "Atendimento online", "presencial", "Atendimento presencial", "Saúde mental", "Qualidade de vida", "Abordagens inovadoras", "Terapia individualizada", "Ambiente acolhedor", "Psicóloga Qualificada", "Psicóloga Empática", "Psicóloga de confiança", "idosos", "terapia para idosos"],
  openGraph: {
    title: "Psicóloga Andreia Taufner",
    description: "Psicóloga Clínica de adolescentes, adultos e idosos em Vila Velha/ES.",
